...
public class UploaderConfigurationLocal {
    ...
    @Bean
    public BiConsumer<InputStream, UploadCompleted.UploadCompletedBuilder> streamConsumer(InFolderObjectStore store) {
    ...
    public DataAcquisitionClient dataAcquisitionClient() {
        return (message, token) -> LOGGER.info(message.toString());
    }
}
